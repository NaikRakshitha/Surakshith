...
import com.surakshith.womensafety.FirebaseAuth.LoginViewModel
import com.surakshith.womensafety.database.Guardian
import com.surakshith.womensafety.database.GuardianDatabase
import com.surakshith.womensafety.databinding.FragmentDashBoardBinding
...
class DashBoardFragment : Fragment() {
    ...
    private fun emergencyFun() {
        ...
        var maillist: String = ""
        val subject: String = "From SURAKSHITH Women Safety App"
        ...
        Snackbar.make(
            activity!!.findViewById(android.R.id.content),
            getString(R.string.yellow_mode),
            Snackbar.LENGTH_LONG
        ).show()
